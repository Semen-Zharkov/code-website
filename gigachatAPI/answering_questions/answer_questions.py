...
from gigachatAPI.answering_questions.docs_filtration import filter_docs, retrieve_docs, multi_vector_retrieve
...
def get_answer(file_path: str, question_list: list[str], dita: int = 0, after_que: bool = False) -> str:
    ...
    for q_num, que in enumerate(question_list, start=1):
        ...
        # filtered_docs = filter_docs(split_docs, que, out_files_num=4)
        filtered_docs = multi_vector_retrieve(split_docs, que)
